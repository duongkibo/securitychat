...
public interface ApiInterface {
    ...
    Call<ApiResponse<Conversation>> createGroup(@Body CreateGroup createGroup);
    @POST("/conversation/addUser/{conversation}")
    Call<ApiResponse<UserInfo>> addUser(@Path("conversation") String conversation,@Body List<UserConversation> userInfo );
