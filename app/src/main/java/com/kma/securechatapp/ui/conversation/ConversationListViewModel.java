...
public class ConversationListViewModel extends ViewModel {
    ...
    public LiveData<Conversation> getResultConvers() {
        return resultConversation;
    }

    public void CreateGroup(CreateGroup createGroup)
    {
        api.createGroup(createGroup).enqueue(new Callback<ApiResponse<Conversation>>() {
            @Override
            public void onResponse(Call<ApiResponse<Conversation>> call, Response<ApiResponse<Conversation>> response) {
                ...
                resultConversation.setValue(response.body().data);
            }
